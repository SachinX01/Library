...
<?php } else {?>
                                            ...
                                            <a href="reg-students.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to activate this student?');""><button class="btn btn-primary"> Activate </button> 
                                            <?php } ?>
